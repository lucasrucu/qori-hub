/* Qori OpenGraph image — canonical reference template.
   ...
   Per app:
     hub                -> "Qori"               / "I build tools I actually use."
     Financial Dashboard-> "Financial Dashboard" / "Multi-bank personal finance, in one place."
     Career Agent       -> "Career Agent"        / "Resume in, tailored applications out."
     Snip               -> "Snip"                / "Short links, click tracking, yours." */

import { ImageResponse } from "next/og";

export const runtime = "edge";
export const alt = "Qori";
